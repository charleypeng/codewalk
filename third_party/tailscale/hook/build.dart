...
void main(List<String> args) async {
  await build(args, (input, output) async {
    ...
    // CodeWalk compiles Windows with a runtime stub because package:tailscale
    // does not support Windows yet. Returning without a code asset keeps the
    // package importable while preventing the unsupported Go native build from
    // breaking Windows release artifacts.
