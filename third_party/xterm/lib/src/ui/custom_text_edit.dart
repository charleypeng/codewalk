  ...
  void _openInputConnection() {
    ...
    if (hasInputConnection) {
      ...
      final config = TextInputConfiguration(
        ...
        // Android keyboards may switch to private/incognito mode when
        // personalized learning is disabled, which also destabilizes
        // composition handling for terminal input.
