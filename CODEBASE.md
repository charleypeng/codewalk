...
lib/presentation/services/project_icon_*          # Planned client-owned project icon discovery/storage/rendering subsystem (ADR-040, issue #73); stores icon metadata locally and keeps OpenCode project payloads authoritative/unchanged
