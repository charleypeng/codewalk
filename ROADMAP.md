...
- [ ] Quando o app mostra o pedido de permissão de acesso a pastas, o balão aparece duas vezes, um em cima e uma mais embaixo, basta responder um que ambos somem. O bug é que deveria aparecer só 1. Uma forma fácil de aparecer é tentar acessar /tmp/
